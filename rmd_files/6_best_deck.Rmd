...
Table_result <- Table_main_side %>%
    ...
    # Table_main_side %>%
     ...
     kableExtra::pack_rows(index = table(Table_main_side$Main_or_side))
...
::: {.column width="50%"}')
    ...
    print(res_global_gt_table[[i]]$any)
    ...
    print(res_global_gt_table[[i]]$count)
...
::: {.column width="50%"}')
    ...
    print(res_main_and_side_gt_table[[i]]$any$main)
    ...
    print(res_main_and_side_gt_table[[i]]$count$main)
...
::: {.column width="50%"}')
    ...
    print(res_main_and_side_gt_table[[i]]$any$side)
    ...
    print(res_main_and_side_gt_table[[i]]$count$side)
...
::: {.column width="50%"}')
    ...
    print(res_global_gt_table_2weeks[[i]]$any)
    ...
    print(res_global_gt_table_2weeks[[i]]$count)
    pander::pandoc.p(":::
::::::::::::::")
  }
...
::: {.column width="50%"}')
    ...
    print(res_main_and_side_gt_table_2weeks[[i]]$any$main)
    ...
    print(res_main_and_side_gt_table_2weeks[[i]]$count$main)
...
::: {.column width="50%"}')
    ...
    print(res_main_and_side_gt_table_2weeks[[i]]$any$side)
    ...
    print(res_main_and_side_gt_table_2weeks[[i]]$count$side)

...
df_export <- readRDS(paste0("../data/",params$format_param,"_data_meta_en_cours.rds")) %>%
  ...
  #   Tournament,Player,
  #   Date,Week,
  #   Draws, Archetype, Archetype_count,Color,Base_Archetype,
  #   Wins, Losses,
  #   Mainboard,Sideboard,
  #   AnchorUri 
  #   )
# df_export$id == row.names(df_export)
# rownames(df_export) <- df_export$id
Number_of_deck <- 7
```
...
```{r compute_res_arch}
total_result_Archetype_best_deck_to_print <- generate_total_result_of_best_deck(fun_par_df = df_export,
...
total_result_base_Archetype_best_deck_to_print <- generate_total_result_of_best_deck(fun_par_df = df_export,
fun_parmin_arch_presence_fun = filter_archetype_count_6,
fun_pardeck_or_side = c("All","Mainboard" ,"Sideboard"),

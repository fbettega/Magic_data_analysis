...
plot_archetype_spaghetti <- (
  ...
  scale_x_discrete(
    "Week",
    breaks = unique(Presence_for_best_deck_plot$Week),
    labels = paste0(
      "Week : ", levels(Presence_for_best_deck_plot$Week), "<br>",
        # unique(Presence_Base_Archetype_for_best_deck_plot$Date), "<br>",
        "N total deck :<br>", Presence_for_best_deck_plot %>%  arrange(Week) %>%  select(Week,Week_deck_number) %>% distinct() %>% 
...
plot_Base_Archetype_spaghetti <- (
  ...
  scale_x_discrete(
    "Week",
    breaks = unique(Presence_Base_Archetype_for_best_deck_plot$Week),
    labels = paste0(

...
(ggplot(data = Archetype_ci_df_plot %>% 
  mutate(
           Archetype = factor(Archetype, levels = .$Archetype[order(.$Arch_winrate_matches + .$CI_Arch_winrate_matches)])
         )
       ) +
  geom_point(
    aes(
    ...
    geom_hline(
      yintercept= c(mean(Archetype_ci_df_plot$Arch_winrate_matches - Archetype_ci_df_plot$CI_Arch_winrate_matches),
...
(ggplot(data = Archetype_ci_df_plot %>% 
  ...
  geom_point(
    ...
    position = position_dodge(0.75)
     ...
     geom_hline(yintercept = mean(Archetype_ci_df_plot$Arch_winrate_matches), linetype="dashed", color = "red") +
    geom_hline(
      yintercept= c(mean(Archetype_ci_df_plot$Arch_winrate_games - Archetype_ci_df_plot$CI_Arch_winrate_games),
...
(ggplot(data = base_Archetype_ci_df_plot %>% 
  ...
  geom_point(
    ...
    geom_hline(
      yintercept= c(mean(base_Archetype_ci_df_plot$Arch_winrate_matches - base_Archetype_ci_df_plot$CI_Arch_winrate_matches),
...
(ggplot(data = base_Archetype_ci_df_plot %>% 
  ...
  geom_point(
    ...
    position = position_dodge(0.75)
     ...
     geom_hline(yintercept = mean(base_Archetype_ci_df_plot$Arch_winrate_matches), linetype="dashed", color = "red") +
    geom_hline(
      yintercept= c(mean(base_Archetype_ci_df_plot$Arch_winrate_games - base_Archetype_ci_df_plot$CI_Arch_winrate_games),

...
fichiers_rmd <- c(
  "1_new_card.Rmd",
  "2_presence_archetype.Rmd",
  "3_Card_win_rate_table.Rmd",
  "4_matrix_WR.Rmd",
  "5_Deck_analysis.Rmd",
  # "6_1_best_deck_all_data.Rmd",
  # "6_2_best_deck_all_data.Rmd",
   "6_best_deck.Rmd",
  "7_last_weeks_winners.Rmd"
)
